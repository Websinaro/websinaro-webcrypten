...
def app():
    ...
    async def echo(request: Request):
        ...
        return Response_bytes(decrypted)
...
# FastAPI route handlers normally return JSON; for raw-byte echo we need
# a plain Response, not the default JSONResponse serializer.
from starlette.responses import Response as Response_bytes
